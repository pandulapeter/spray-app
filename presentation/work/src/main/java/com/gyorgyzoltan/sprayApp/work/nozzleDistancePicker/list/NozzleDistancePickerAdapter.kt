...
internal class NozzleDistancePickerAdapter(
    ...
    private val onNozzleDistanceChanged: (Float) -> Unit,
    ...
    override fun getItemViewType(position: Int) = when (getItem(position)) {
        ...
        is NozzleDistanceInputViewHolder.UiModel -> R.layout.item_nozzle_distance_input
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*, *> = when (viewType) {
        ...
        R.layout.item_nozzle_distance_input -> NozzleDistanceInputViewHolder.create(parent, onNozzleDistanceChanged)
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<*, *>, position: Int) = when (holder) {
        ...
        is NozzleDistanceInputViewHolder -> holder.bind(getItem(position) as NozzleDistanceInputViewHolder.UiModel)
