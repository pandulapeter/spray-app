...
import com.gyorgyzoltan.sprayApp.presentation.databinding.ItemNozzlePickerNozzleDarkBinding
...
internal class NozzleDarkViewHolder private constructor(
    binding: ItemNozzlePickerNozzleDarkBinding,
    onItemClicked: (Nozzle) -> Unit
) : BaseViewHolder<ItemNozzlePickerNozzleDarkBinding, NozzleDarkViewHolder.UiModel>(binding) {
