...
open class BaseAdapter<T : ListItem>(
    ...
    @CallSuper
    override fun getItemViewType(position: Int): Int = throw  IllegalArgumentException("Unsupported item type at position $position.")

    @CallSuper
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*, *> = throw  IllegalArgumentException("Unsupported item view type: $viewType.")

    @CallSuper
    override fun onBindViewHolder(holder: BaseViewHolder<*, *>, position: Int): Unit = throw  IllegalArgumentException("Unsupported item type at position $position.")
